...
function cmaq_viz(cmaq_mpo_data) {
	...
	// Generate line charts for the CMAQ data
	...
	yValues_perf = [ null, null, non_sov.perf_2021, non_sov.perf_2019 ];
	yValues_baseline = [];
	...
	yValues_perf = [ null, null, phed.perf_2021, phed.perf_2019 ];
	yValues_baseline = [];
	...
	yValues_perf = [ null, null, emissions.perf_2021, emissions.perf_2019 ];
	yValues_baseline = [];
